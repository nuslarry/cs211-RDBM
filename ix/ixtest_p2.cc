...
//    for(int i = 0; i < numOfTuples; i++){if(A[i]==140)cout<<"140 pos="<<i<<endl;}
    // Insert entries
    for(int i = 0; i < numOfTuples; i++)
    {
...
//    	cout<<"i="<<i<<endl;
        ...
        rid.pageNum = i+1;
        rid.slotNum = i+1;
//        if(i==51)cout<<"GGG"<<endl;
//if(key==140)cout<<"hahahah"<<endl;
//        cout<<"key="<<key<<endl;
...
//
        ...
        assert(rc == success && "indexManager::insertEntry() should not fail.");
//       indexManager->printAllLeafPage(ixfileHandle2,attribute);
//        cout<<"please enter test to continue"<<endl;
    }

    compVal = 5000;
//    indexManager->printAllLeafPage(ixfileHandle1,attribute);
    // Conduct a scan
    return 0;
...
//    	cout<<"count="<<count<<endl;
        ...
        if (ix_ScanIterator2.getNextEntry(rid2, &key2) != success 
        	...
        	cout<<"rid.pageNum="<<rid.pageNum<<",rid2.pageNum="<<rid2.pageNum<<endl;
