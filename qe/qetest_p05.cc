...
//	cout<<"@@";
	...
	BNLJoin *bnlJoin = new BNLJoin(childBNLJoin, rightIn2, joinCond2, 51);
...
//	bnlJoin->getAttributes(attrs);
//	for(Attribute a : attrs)cout<<a.name<<endl;
//	void* data11=malloc(PAGE_SIZE);
//	while (bnlJoin->getNextTuple(data11) != QE_EOF) {
//
//		cout<<"lol";
//		RelationManager::instance()->printTuple(attrs,data11);
//	}
//cout<<"serious?"<<endl;
//	return 0;
