...
//	while (ts->getNextTuple(test) != QE_EOF) {
//		cout<<"= =";
//		vector<Attribute> temp;
//		ts->getAttributes(temp);
//		RelationManager::instance()->printTuple(temp,test);
//	}
//
//return 0;
	...
	*(int *) value2.data = compVal;
	...
	// left.B [10-109] : 40
//	cout<<"count="<<count<<",nullCount1="<<nullCount1<<",nullCount2="<<nullCount2<<endl;
